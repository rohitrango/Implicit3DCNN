'''
Code for UNet 3D variants borrowed from https://github.com/wolny/pytorch-3dunet/

Batch norm is replaced with Instance Norm
'''
...
if __name__ == '__main__':
    ...
    inp = torch.rand(1, 7, 64, 64, 64).cuda()
    out = net(inp)
    print(net)
    print(out.shape)
    input()
